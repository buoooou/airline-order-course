...
RUN ls -la /app/dist/frontend  # 查看 dist 目录下的内容（根据实际工作目录调整）
RUN echo "===== 详细目录结构 ====="
RUN ls -la /app/dist/frontend  # 查看是否有 frontend 子目录
RUN ls -la /app/dist/frontend/browser  # 查看是否有 browser 子目录
