...
-- 步骤 4: 定义分布式锁表
-- Shadlock分布式锁表：用于存储定时任务的锁信息
CREATE TABLE IF NOT EXISTS shedlock (
    name VARCHAR(64) NOT NULL PRIMARY KEY, -- 锁名称（通常是任务名）
    lock_until TIMESTAMP(3) NOT NULL,      -- 锁释放时间
    locked_at TIMESTAMP(3) NOT NULL,       -- 锁获取时间
    locked_by VARCHAR(255) NOT NULL        -- 持有锁的节点标识
);
...
(1, 'admin', '$2a$10$UgwHbvl57eDPgT2R1P6PS.b3eIXwOXAyHG.nigw0.icoasFeq9udq', 'ADMIN'),
(2, 'user', '$2a$10$UgwHbvl57eDPgT2R1P6PS.b3eIXwOXAyHG.nigw0.icoasFeq9udq', 'USER');
