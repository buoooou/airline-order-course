...
--  3. 创建 orders 表 (订单信息) 和 航班信息表 flights
...
-- 插入覆盖所有场景的订单数据
INSERT INTO `orders` (`order_number`, `status`, `amount`, `creation_date`, `user_id`, `flight_id`) VALUES
...
('TIC-3C4D5E6F', 'TICKETING_FAILED', 980.50, NOW() - INTERVAL 2 HOUR, 1, 1),
...
('CAN-6F7G8H9I', 'CANCELLED', 1100.20, NOW() - INTERVAL 2 DAY, 2, 2),
